        ...
        <div className="container mt-3">
          ...
          <form onSubmit={this.login}>
            <div className="bg-black text-white ">
              ...
              <input type="text" className="text-white bg-gray-500" id="username" name="username" value={this.state.username} onChange={this.handleUserNameChange} />
            </div>
            <div className="form-group">
              <label htmlFor="username">Password</label>
              <input type="password" className="text-white bg-gray-500" id="password" name="password" value={this.state.password} onChange={this.handlePasswordChange} />
              <div>
                {this.state.error &&
                  <small >
                    {this.state.error}
