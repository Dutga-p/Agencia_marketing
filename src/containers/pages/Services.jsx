    ...
    <Layout>
      ...
      <div className="pt-28">
        ...
        <div className="serviciosT">
          ...
          <br />
          <p>
            Precio: 100.000,  Tiempo estimado: 3 horas
          </p>
        </div>
        <br/>
        <div className="serviciosT">
          <h2 className="text-3xl   text-black  font-bold mb-8"> <span className=" border-b-4 border-orange-button"> Reparación del Sistema Eléctrico </span></h2>
          <p>
        ...
        <br/>
        <div className="serviciosT">
          <h2 className="text-3xl  text-black font-bold mb-8"> <span className=" border-b-4 border-orange-button"> Reparación de Aire Acondicionado </span></h2>
          <p>
        ...
        <br/>
        <div className="serviciosT">
          <h2 className="text-3xl  text-black font-bold mb-8"> <span className=" border-b-4 border-orange-button"> Cambio de Aceite </span></h2>
          <p>
        ...
        <br/>
        <div className="serviciosT" >
          <h2 className="text-3xl  text-black font-bold mb-8"> <span className=" border-b-4 border-orange-button"> Mantenimiento General </span></h2>
          <p>
